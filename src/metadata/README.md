 ...
 * [vfbext.yml](vfbext.yml)
     * Determines how your purl.obolibrary.org/obo/vfbext/ redirects will be handled
     ...
     * Paste in the contents of [vfbext.yml](vfbext.yml)
 ...
 * [vfbext.md](vfbext.md)
     ...
     * Paste in the contents of [vfbext.md](vfbext.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
